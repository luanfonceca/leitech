...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('address', (
            ...
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'folks_address_updated_histories', null=True, to=orm['accounts.User'], blank=True)),
            ...
            ('region', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('zipcode', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'folks_address_created_histories', null=True, to=orm['accounts.User'], blank=True)),
