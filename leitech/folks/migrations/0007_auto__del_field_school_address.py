...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('school', 'address_id')


    def backwards(self, orm):
        # Adding field 'School.address'
        db.add_column('school', 'address',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['folks.Address'], unique=True),
                      keep_default=False)
