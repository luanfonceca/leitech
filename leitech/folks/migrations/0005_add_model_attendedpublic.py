...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('attended_public', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'folks_attendedpublic_created_histories', null=True, to=orm['accounts.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'folks_attendedpublic_updated_histories', null=True, to=orm['accounts.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'folks', ['AttendedPublic'])
