...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Police'
        db.create_table('police', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'folks_police_created_histories', null=True, to=orm['accounts.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'folks_police_updated_histories', null=True, to=orm['accounts.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('police_car', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='polices', null=True, to=orm['folks.PoliceCar'])),
        ))
        db.send_create_signal(u'folks', ['Police'])


    def backwards(self, orm):
        # Deleting model 'Police'
        db.delete_table('police')
