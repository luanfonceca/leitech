...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('address', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'folks_address_created_histories', null=True, to=orm['accounts.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'folks_address_updated_histories', null=True, to=orm['accounts.User'])),
            ...
            ('neighborhood', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ...
            ('complement', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'folks', ['Address'])
