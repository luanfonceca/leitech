...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seized_material_type', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_seizedmaterialtype_created_histories', null=True, to=orm['core.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_seizedmaterialtype_updated_histories', null=True, to=orm['core.User'])),
