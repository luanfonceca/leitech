...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AttendedPublic'
        db.create_table('attended_public', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_attendedpublic_created_histories', null=True, to=orm['core.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_attendedpublic_updated_histories', null=True, to=orm['core.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'core', ['AttendedPublic'])


        # Renaming column for 'Occurrence.attended_public' to match new field type.
        db.rename_column('occurrence', 'attended_public', 'attended_public_id')
        # Changing field 'Occurrence.attended_public'
        db.alter_column('occurrence', 'attended_public_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['core.AttendedPublic']))
        # Adding index on 'Occurrence', fields ['attended_public']
        db.create_index('occurrence', ['attended_public_id'])


    def backwards(self, orm):
        # Removing index on 'Occurrence', fields ['attended_public']
        db.delete_index('occurrence', ['attended_public_id'])

        # Deleting model 'AttendedPublic'
        db.delete_table('attended_public')


        # Renaming column for 'Occurrence.attended_public' to match new field type.
        db.rename_column('occurrence', 'attended_public_id', 'attended_public')
        # Changing field 'Occurrence.attended_public'
        db.alter_column('occurrence', 'attended_public', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        u'core.attendedpublic': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'core_attendedpublic_created_histories'", 'null': 'True', 'to': u"orm['core.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'core_attendedpublic_updated_histories'", 'null': 'True', 'to': u"orm['core.User']"})
        },
        u'core.occurrence': {
