...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('occurrence', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_occurrence_created_histories', null=True, to=orm['accounts.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_occurrence_updated_histories', null=True, to=orm['accounts.User'])),
            ...
            ('police_car', self.gf('django.db.models.fields.related.ForeignKey')(related_name='occurrences', on_delete=models.PROTECT, to=orm['folks.PoliceCar'])),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(related_name='occurrences', on_delete=models.PROTECT, to=orm['folks.School'])),
            ('attended_public', self.gf('django.db.models.fields.related.ForeignKey')(related_name='occurrences', on_delete=models.PROTECT, to=orm['folks.AttendedPublic'])),
        ))
    ...
    models = {
        ...
        u'core.occurrence': {
            ...
            'school': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'occurrences'", 'on_delete': 'models.PROTECT', 'to': u"orm['folks.School']"}),
        ...
        u'folks.address': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'folks_address_created_histories'", 'null': 'True', 'to': u"orm['accounts.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'folks_address_updated_histories'", 'null': 'True', 'to': u"orm['accounts.User']"}),
        ...
        u'folks.school': {
            ...
            'address': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['folks.Address']", 'unique': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
