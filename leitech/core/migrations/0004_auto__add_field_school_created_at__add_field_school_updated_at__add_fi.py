...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.created_at'
        db.add_column('school', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'School.updated_at'
        db.add_column('school', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'School.created_by'
        db.add_column('school', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_school_created_histories', null=True, to=orm['core.User']),
                      keep_default=False)

        # Adding field 'School.updated_by'
        db.add_column('school', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_school_updated_histories', null=True, to=orm['core.User']),
                      keep_default=False)

        # Adding field 'Address.created_at'
        db.add_column('address', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Address.updated_at'
        db.add_column('address', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Address.created_by'
        db.add_column('address', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_address_created_histories', null=True, to=orm['core.User']),
                      keep_default=False)

        # Adding field 'Address.updated_by'
        db.add_column('address', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_address_updated_histories', null=True, to=orm['core.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.created_at'
        db.delete_column('school', 'created_at')

        # Deleting field 'School.updated_at'
        db.delete_column('school', 'updated_at')

        # Deleting field 'School.created_by'
        db.delete_column('school', 'created_by_id')

        # Deleting field 'School.updated_by'
        db.delete_column('school', 'updated_by_id')

        # Deleting field 'Address.created_at'
        db.delete_column('address', 'created_at')

        # Deleting field 'Address.updated_at'
        db.delete_column('address', 'updated_at')

        # Deleting field 'Address.created_by'
        db.delete_column('address', 'created_by_id')

        # Deleting field 'Address.updated_by'
        db.delete_column('address', 'updated_by_id')
