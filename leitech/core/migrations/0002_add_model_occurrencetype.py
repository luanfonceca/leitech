...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OccurrenceType'
        db.create_table('occurrence_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_occurrencetype_created_histories', null=True, to=orm['accounts.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_occurrencetype_updated_histories', null=True, to=orm['accounts.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'core', ['OccurrenceType'])


    def backwards(self, orm):
        # Deleting model 'OccurrenceType'
        db.delete_table('occurrence_type')
