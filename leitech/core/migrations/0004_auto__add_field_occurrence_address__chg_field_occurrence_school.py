...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Occurrence.address'
        db.add_column('occurrence', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='occurrences', null=True, on_delete=models.PROTECT, to=orm['folks.Address']),
                      keep_default=False)


        # Changing field 'Occurrence.school'
        db.alter_column('occurrence', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['folks.School']))

    def backwards(self, orm):
        # Deleting field 'Occurrence.address'
        db.delete_column('occurrence', 'address_id')


        # Changing field 'Occurrence.school'
        db.alter_column('occurrence', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, on_delete=models.PROTECT, to=orm['folks.School']))
    ...
    models = {
        ...
        u'core.occurrence': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'occurrences'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['folks.Address']"}),
