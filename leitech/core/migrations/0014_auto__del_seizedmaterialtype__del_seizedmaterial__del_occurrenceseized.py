...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('seized_material_type', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'core_seizedmaterialtype_created_histories', null=True, to=orm['accounts.User'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'core_seizedmaterialtype_updated_histories', null=True, to=orm['accounts.User'], blank=True)),
        ))
        db.send_create_signal(u'core', ['SeizedMaterialType'])

        # Adding model 'SeizedMaterial'
        db.create_table('seized_material', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'core_seizedmaterial_updated_histories', null=True, to=orm['accounts.User'], blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seized_materials', null=True, to=orm['core.SeizedMaterialType'], on_delete=models.PROTECT, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'core_seizedmaterial_created_histories', null=True, to=orm['accounts.User'], blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['SeizedMaterial'])
        ...
        db.create_table('occurrence_seized_material', (
            ...
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'core_occurrenceseizedmaterial_updated_histories', null=True, to=orm['accounts.User'], blank=True)),
            ('seized_material', self.gf('django.db.models.fields.related.ForeignKey')(related_name='occurrence_seized_material', to=orm['core.SeizedMaterial'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'core_occurrenceseizedmaterial_created_histories', null=True, to=orm['accounts.User'], blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['OccurrenceSeizedMaterial'])
