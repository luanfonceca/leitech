...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Occurrence.accident_report'
        db.alter_column('occurrence', 'accident_report', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Adding field 'Occurrence.address'
        db.add_column('occurrence', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='occurrences', null=True, to=orm['folks.Address'], on_delete=models.PROTECT, blank=True),
                      keep_default=False)


        # Changing field 'Occurrence.accident_report'
        db.alter_column('occurrence', 'accident_report', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
