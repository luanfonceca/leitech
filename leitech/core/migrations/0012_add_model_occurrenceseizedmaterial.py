...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('occurrence_seized_material', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_occurrenceseizedmaterial_created_histories', null=True, to=orm['core.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_occurrenceseizedmaterial_updated_histories', null=True, to=orm['core.User'])),
            ('amount', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('occurrence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Occurrence'])),
            ('seized_material', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SeizedMaterial'])),
        ))
    ...
    models = {
        ...
        u'core.occurrenceseizedmaterial': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'core_occurrenceseizedmaterial_created_histories'", 'null': 'True', 'to': u"orm['core.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'occurrence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Occurrence']"}),
            'seized_material': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.SeizedMaterial']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'core_occurrenceseizedmaterial_updated_histories'", 'null': 'True', 'to': u"orm['core.User']"})
        },
