...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seized_material', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_seizedmaterial_created_histories', null=True, to=orm['core.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'core_seizedmaterial_updated_histories', null=True, to=orm['core.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seized_materials', null=True, on_delete=models.PROTECT, to=orm['core.SeizedMaterialType'])),
        ))
